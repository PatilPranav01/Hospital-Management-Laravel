...
<header>
	<nav class="navbar navbar-expand-lg navbar-light bg-white shadow py-3">
		<div class="container">
			<a class="navbar-brand" href="{{ url('/') }}">HealthCareHub</a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				@if (!Auth::check())
					<a class="btn btn-outline-primary me-2" href="{{ route('login.form') }}" type="button">Login</a>
				@else
					<a class="btn btn-outline-primary me-2" href="{{ route('profile') }}" type="button">Account</a>
...
<footer class="bg-dark py-3 bg-2">
	<div class="container">
		<p class="text-center text-white pt-3 fw-bold fs-6">© 2024 HealthCareHub, all rights reserved</p>
	</div>
</footer> 
